...
void USB_LP_CAN1_RX0_IRQHandler(void)
{
	...
	if(RxMessage.StdId == 0x10)
	{
		...
		num = (RxMessage.Data[0]<<3)|(RxMessage.Data[1]<<2)|(RxMessage.Data[2]<<1)|(RxMessage.Data[3]);
		num = ((num & 0x000f)<<4)|0x0f0f;
		HC595SendData(num);		
	}
...
{	
	...
	u16 i=0;
	CanTxMsg TxMessage;
	TxMessage.StdId=shumaguan_num;	// ±ê×¼±êÊ¶·û 
...
void send(void)
{
	...
	temp[1] = IN8|(IN9<<1)|(IN10<<2)|(IN11<<3);
